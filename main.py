...
from rogueBoid import RogueBoid

default_boids = 100
default_rogue_boids = 5
default_geometry = "1000x1000"


def update(dt, boids, rogue_boids):
    """
    ...
    for rogue_boid in rogue_boids:
        rogue_boid.update(dt, rogue_boids)
...
def main(args):
    ...
    rogue_boids = pg.sprite.RenderUpdates()
    add_rogue_boids(rogue_boids, args.num_rogue_boids)
...
def add_rogue_boids(rogue_boids, num_rogue_boids):
    for _ in range(num_rogue_boids):
        rogue_boids.add(RogueBoid())
...
if __name__ == "__main__":
    ...
    parser.add_argument('--rogue-number', dest='num_rogue_boids', default=default_rogue_boids,
                        help='number of rogue boids to generate')
